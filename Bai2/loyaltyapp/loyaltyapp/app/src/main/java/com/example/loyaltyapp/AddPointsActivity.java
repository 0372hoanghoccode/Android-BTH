...
public class AddPointsActivity extends AppCompatActivity {
    ...
    private Button btnSearch, btnAddPoints, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddPoints.setOnClickListener(v -> addPointsToCustomer());
        btnBack = findViewById(R.id.btnBack);
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(AddPointsActivity.this, MenuActivity.class);
    ...
    private void loadCustomerData() {
        ...
        try {
            ...
            Log.e("AddPointsActivity", "Lỗi khi đọc file XML", e);
    ...
    private void updateCustomerDataInXML() {
        try {
            ...
            Log.e("AddPointsActivity", "Lỗi khi cập nhật file XML", e);
